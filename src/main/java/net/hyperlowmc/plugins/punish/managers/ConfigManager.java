...
public class ConfigManager {
    ...
    public ConfigManager(Punish plugin) {
        this.plugin = plugin;
    ...
    private void createDefaultConfig() {
        ...
        punishmentConfigs.put("hacking", new PunishmentConfig(
                ...
                PunishmentType.BAN,
                Arrays.asList(
                        new PunishmentStep(1, 90 * 24 * 60 * 60 * 1000L), // 90 days
                        new PunishmentStep(2, 120 * 24 * 60 * 60 * 1000L), // 120 days
                        new PunishmentStep(3, -1L) // Permanent
                )
        ));
        ...
        punishmentConfigs.put("toxicity", new PunishmentConfig(
                ...
                PunishmentType.MUTE,
                Arrays.asList(
                        new PunishmentStep(1, 24 * 60 * 60 * 1000L), // 1 day
                        new PunishmentStep(2, 7 * 24 * 60 * 60 * 1000L), // 7 days
                        new PunishmentStep(3, -1L) // Permanent
                )
        ));
        ...
        punishmentConfigs.put("spam", new PunishmentConfig(
                ...
                PunishmentType.KICK,
                Arrays.asList(
                        new PunishmentStep(1, 0L), // Kick
                        new PunishmentStep(2, 60 * 60 * 1000L), // 1 hour mute
                        new PunishmentStep(3, 24 * 60 * 60 * 1000L) // 1 day mute
                )
        ));
    ...
    public static class PunishmentStep {
        int offense;
        long duration; // -1 for permanent, 0 for kick
